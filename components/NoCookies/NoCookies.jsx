...
export function NoCookies() {
	return (
		<div className="fixed right-0 bottom-0 p-2">
			<div className="min-w-12 w-12 min-h-12 h-12 rounded-full flex justify-end items-center cursor-pointer px-1 py-1 gap-2 group hover:w-56 transition-all duration-200 bg-primary ">
